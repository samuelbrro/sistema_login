                ...
                if ($sql->execute(array($nome, $email, $senha_cript, $recupera_senha, $token, $codigo_confirmacao, $status, $data_cadastro))) {
                    ...
                    if ($modo == "producao") {
                        ...
                        try {
                            ...
                            //Recipients
                            $mail->setFrom('samuel.rodriguies1991@hotmail.com', 'Sistema de Login'); //QUEM ESTÁ MANDANDO O EMAIL
    ...
    <form method="post">
        ...
        <div class="input-group">
            ...
            <input <?php if (isset($erro_geral) or isset($erro_email)) {
                        echo 'class="erro-input"';
                    } ?> type="email" name="email" placeholder="Seu melhor email" <?php if (isset($_POST['email'])) {
        ...
        <div class="input-group">
            ...
            <input type="password" <?php if (isset($erro_geral) or isset($erro_senha)) {
                                        echo 'class="erro-input"';
                                    } ?> name="senha" placeholder="Senha mínimo 6 Dígitos" <?php if (isset($_POST['senha'])) {
        ...
        <div class="input-group">
            ...
            <input type="password" <?php if (isset($erro_geral) or isset($erro_repete_senha)) {
                                        echo 'class="erro-input"';
                                    } ?> name="repete_senha" placeholder="Repita a senha criada" <?php if (isset($_POST['repete_senha'])) {
